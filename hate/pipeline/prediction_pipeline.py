...
class PredictionPipeline:
    def __init__(self):
        ...
        self.s3 = s3Operation()
        self.data_transformation = DataTransformation(data_transformation_config= DataTransformationConfig,data_ingestion_artifacts=DataIngestionArtifact)
    ...
    def get_model_from_s3(self) -> str:
        ...
        Description :   This method to get best model from s3 storage
        ...
        try:
            ...
            self.s3.sync_folder_from_s3(self.bucket_name, self.model_name, self.model_path)
